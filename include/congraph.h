...
{	
	...
	lmu::Graph createRandomConnectionGraph(double edgePropability, int numConnectedComponents, const std::vector<std::shared_ptr<lmu::ImplicitFunction>>& impFuncs);
	lmu::Graph createRandomConnectionGraph(double edgePropability, const std::vector<std::shared_ptr<lmu::ImplicitFunction>>& impFuncs);
